...
1. Idea Honing - refine the idea
2. Task Decomposition - break down the task into smaller tasks
3. Implementation - implement the tasks one by one.
...
- Caching
- Batching
- Cost estimation and tracking (i.e. how many tokens are you using?)
