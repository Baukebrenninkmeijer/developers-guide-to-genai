...
<div style="display: flex; align-items: flex-end; width: 100%; overflow: visible; position: relative; top: -85%;z-index:-10">
  <img src="img/gpt3.5.svg" style="width:3%; margin-right: 10px; z-index: -10;">
  <img src="img/gemini2_5pro.svg" style="width:80%; z-index: -10;">
</div>

---

## Context windows=exploded {.center}
...
Things made possible with reasoning.
